...
func newAggregatorCumulative(now time.Time, newAggregateValue func() AggregateValue) *aggregatorCumulative {
...
func (a *aggregatorCumulative) retrieveCollected(now time.Time) AggregateValue {
	return a.av
}
