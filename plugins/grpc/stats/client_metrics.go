...
func registerDefaultViewsClient() {
	...
	RPCClientErrorCountView = istats.NewViewInt64("grpc.io/client/error_count/distribution_cumulative", "RPC Errors", []tags.Key{keyOpStatus, keyService, keyMethod}, RPCClientErrorCount, aggCount, windowCumulative)
	views = append(views, RPCClientErrorCountView)
	RPCClientRoundTripLatencyView = istats.NewViewFloat64("grpc.io/client/roundtrip_latency/distribution_cumulative", "Latency in msecs", []tags.Key{keyService, keyMethod}, RPCClientRoundTripLatency, aggDistMillis, windowCumulative)
	views = append(views, RPCClientRoundTripLatencyView)
	// RPCClientServerElapsedTimeView = istats.NewViewFloat64("grpc.io/client/server_elapsed_time/distribution_cumulative", "Server elapsed time in msecs", []tags.Key{keyService, keyMethod}, RPCClientServerElapsedTime, aggDistMillis, windowCumulative)
	// views = append(views, RPCClientServerElapsedTimeView)
	RPCClientRequestBytesView = istats.NewViewInt64("grpc.io/client/request_bytes/distribution_cumulative", "Request bytes", []tags.Key{keyService, keyMethod}, RPCClientRequestBytes, aggDistBytes, windowCumulative)
	views = append(views, RPCClientRequestBytesView)
	RPCClientResponseBytesView = istats.NewViewInt64("grpc.io/client/response_bytes/distribution_cumulative", "Response bytes", []tags.Key{keyService, keyMethod}, RPCClientResponseBytes, aggDistBytes, windowCumulative)
	...
	RPCClientRequestCountView = istats.NewViewInt64("grpc.io/client/request_count/distribution_cumulative", "Count of request messages per client RPC", []tags.Key{keyService, keyMethod}, RPCClientRequestCount, aggDistCounts, windowCumulative)
	views = append(views, RPCClientRequestCountView)
	RPCClientResponseCountView = istats.NewViewInt64("grpc.io/client/response_count/distribution_cumulative", "Count of response messages per client RPC", []tags.Key{keyService, keyMethod}, RPCClientResponseCount, aggDistCounts, windowCumulative)
