...
func runTestsAndCollectMetrics() *graphTemplate {
	...
	tracedKey := "yesTraceYesStatsClientYesTraceYesStatsServer"
	unTracedKey := "plainClientPlainServer"
	funcsMap := map[string]func(*testing.B, int){
		// tracedKey:   benchmarkYesTraceYesStatsClientYesTraceYesStatsServer,
		// unTracedKey: benchmarkPlainClientPlainServer,
	}
	...
	return &graphTemplate{Traced: graphingMap[tracedKey], Untraced: graphingMap[unTracedKey]}
}
