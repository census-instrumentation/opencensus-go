...
func defaultClientViews() {
	RPCClientErrorCountView, _ = stats.NewView("grpc.io/client/error_count/cumulative", "RPC Errors", []tag.Key{keyOpStatus, keyService, keyMethod}, RPCClientErrorCount, aggCount, windowCumulative)
	...
	RPCClientRoundTripLatencyMinuteView, _ = stats.NewView("grpc.io/client/roundtrip_latency/minute", "Minute stats for latency in msecs", []tag.Key{keyService, keyMethod}, RPCClientRoundTripLatency, aggDistMillis, windowSlidingMinute)
	clientViews = append(clientViews, RPCClientRoundTripLatencyMinuteView)
	RPCClientRequestBytesMinuteView, _ = stats.NewView("grpc.io/client/request_bytes/minute", "Minute stats for request size in bytes", []tag.Key{keyService, keyMethod}, RPCClientRequestBytes, aggCount, windowSlidingMinute)
	clientViews = append(clientViews, RPCClientRequestBytesMinuteView)
	RPCClientResponseBytesMinuteView, _ = stats.NewView("grpc.io/client/response_bytes/minute", "Minute stats for response size in bytes", []tag.Key{keyService, keyMethod}, RPCClientResponseBytes, aggCount, windowSlidingMinute)
	clientViews = append(clientViews, RPCClientResponseBytesMinuteView)
	RPCClientErrorCountMinuteView, _ = stats.NewView("grpc.io/client/error_count/minute", "Minute stats for rpc errors", []tag.Key{keyService, keyMethod}, RPCClientErrorCount, aggCount, windowSlidingMinute)
	clientViews = append(clientViews, RPCClientErrorCountMinuteView)
	RPCClientStartedCountMinuteView, _ = stats.NewView("grpc.io/client/started_count/minute", "Minute stats on the number of client RPCs started", []tag.Key{keyService, keyMethod}, RPCClientStartedCount, aggCount, windowSlidingMinute)
	clientViews = append(clientViews, RPCClientStartedCountMinuteView)
	RPCClientFinishedCountMinuteView, _ = stats.NewView("grpc.io/client/finished_count/minute", "Minute stats on the number of client RPCs finished", []tag.Key{keyService, keyMethod}, RPCClientFinishedCount, aggCount, windowSlidingMinute)
	clientViews = append(clientViews, RPCClientFinishedCountMinuteView)
	RPCClientRequestCountMinuteView, _ = stats.NewView("grpc.io/client/request_count/minute", "Minute stats on the count of request messages per client RPC", []tag.Key{keyService, keyMethod}, RPCClientRequestCount, aggCount, windowSlidingMinute)
	clientViews = append(clientViews, RPCClientRequestCountMinuteView)
	RPCClientResponseCountMinuteView, _ = stats.NewView("grpc.io/client/response_count/minute", "Minute stats on the count of response messages per client RPC", []tag.Key{keyService, keyMethod}, RPCClientResponseCount, aggCount, windowSlidingMinute)
	clientViews = append(clientViews, RPCClientResponseCountMinuteView)

	RPCClientRoundTripLatencyHourView, _ = stats.NewView("grpc.io/client/roundtrip_latency/hour", "Hour stats for latency in msecs", []tag.Key{keyService, keyMethod}, RPCClientRoundTripLatency, aggDistMillis, windowSlidingHour)
	clientViews = append(clientViews, RPCClientRoundTripLatencyHourView)
	RPCClientRequestBytesHourView, _ = stats.NewView("grpc.io/client/request_bytes/hour", "Hour stats for request size in bytes", []tag.Key{keyService, keyMethod}, RPCClientRequestBytes, aggCount, windowSlidingHour)
	clientViews = append(clientViews, RPCClientRequestBytesHourView)
	RPCClientResponseBytesHourView, _ = stats.NewView("grpc.io/client/response_bytes/hour", "Hour stats for response size in bytes", []tag.Key{keyService, keyMethod}, RPCClientResponseBytes, aggCount, windowSlidingHour)
	clientViews = append(clientViews, RPCClientResponseBytesHourView)
	RPCClientErrorCountHourView, _ = stats.NewView("grpc.io/client/error_count/hour", "Hour stats for rpc errors", []tag.Key{keyService, keyMethod}, RPCClientErrorCount, aggCount, windowSlidingHour)
	clientViews = append(clientViews, RPCClientErrorCountHourView)
	RPCClientStartedCountHourView, _ = stats.NewView("grpc.io/client/started_count/hour", "Hour stats on the number of client RPCs started", []tag.Key{keyService, keyMethod}, RPCClientStartedCount, aggCount, windowSlidingHour)
	clientViews = append(clientViews, RPCClientStartedCountHourView)
	RPCClientFinishedCountHourView, _ = stats.NewView("grpc.io/client/finished_count/hour", "Hour stats on the number of client RPCs finished", []tag.Key{keyService, keyMethod}, RPCClientFinishedCount, aggCount, windowSlidingHour)
	clientViews = append(clientViews, RPCClientFinishedCountHourView)
	RPCClientRequestCountHourView, _ = stats.NewView("grpc.io/client/request_count/hour", "Hour stats on the count of request messages per client RPC", []tag.Key{keyService, keyMethod}, RPCClientRequestCount, aggCount, windowSlidingHour)
	clientViews = append(clientViews, RPCClientRequestCountHourView)
	RPCClientResponseCountHourView, _ = stats.NewView("grpc.io/client/response_count/hour", "Hour stats on the count of response messages per client RPC", []tag.Key{keyService, keyMethod}, RPCClientResponseCount, aggCount, windowSlidingHour)
