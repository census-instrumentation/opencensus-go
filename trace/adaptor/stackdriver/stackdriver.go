// Package stackdriver enables uploading trace spans to Stackdriver Trace.
//
// To use, import the package and call EnableExport.
//
// Example:
//
// 	import "github.com/census-instrumentation/opencensus-go/trace/adaptor/stackdriver"
//
